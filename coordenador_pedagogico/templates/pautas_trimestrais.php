...
function buscarNotasAlunos($pdo, $classe, $turma, $disciplinas, $trimestre) {
    $resultado = [
        'success' => true,
        'alunos' => [],
        'trimestre' => $trimestre,
...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['action'])) {
    ...
    if ($action === 'buscar_dados') {
        ...
        $resultado = buscarNotasAlunos($pdo, $classe, $turma, $disciplinas, $trimestre);
    ...
    fetch(url)
        ...
        .then(function(data) {
            ...
            if (data.success) {
                ...
                mostrarMensagem('success', 'Pauta gerada com sucesso!');
            } else {
                mostrarMensagem('error', data.message || 'Erro ao gerar pauta');
            }
        })
