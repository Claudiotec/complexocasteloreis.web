...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ===== ESTILOS EXCLUSIVOS PARA NOTIFICAÇÕES ===== */
        ...
        .notifications-toggle .fa-chevron-down {
        ...
        .notifications-toggle.open .fa-chevron-down {
...
?>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?= SITE_URL ?>professor/dashboard.php" class="<?= basename($_SERVER['PHP_SELF']) == 'dashboard.php' ? 'active' : '' ?>">
                <i class="fas fa-th-large"></i> Dashboard
            </a>
            
            <a href="<?= SITE_URL ?>professor/horarios.php" class="<?= basename($_SERVER['PHP_SELF']) == 'horarios.php' ? 'active' : '' ?>">
                <i class="fas fa-clock"></i> Horários
                <span class="badge-nav"><?= $total_turmas ?? 0 ?></span>
            </a>
            
            <a href="<?= SITE_URL ?>professor/disciplinas.php" class="<?= basename($_SERVER['PHP_SELF']) == 'disciplinas.php' ? 'active' : '' ?>">
                <i class="fas fa-book"></i> Disciplinas
                <span class="badge-nav"><?= $total_disciplinas ?? 0 ?></span>
            </a>
            
            <a href="<?= SITE_URL ?>professor/turmas.php" class="<?= basename($_SERVER['PHP_SELF']) == 'turmas.php' ? 'active' : '' ?>">
                <i class="fas fa-users"></i> Turmas
                <span class="badge-nav"><?= $total_turmas ?? 0 ?></span>
            </a>
            
            <a href="<?= SITE_URL ?>professor/avaliacoes.php" class="<?= basename($_SERVER['PHP_SELF']) == 'avaliacoes.php' ? 'active' : '' ?>">
                <i class="fas fa-star"></i> Avaliações
            </a>
            
            <a href="<?= SITE_URL ?>professor/pautas_trimestrais.php" class="<?= basename($_SERVER['PHP_SELF']) == 'pautas_trimestrais.php' ? 'active' : '' ?>">
                <i class="fas fa-list-alt"></i> Pautas Trimestrais
            </a>
            
            <a href="<?= SITE_URL ?>professor/pautas_finais.php" class="<?= basename($_SERVER['PHP_SELF']) == 'pautas_finais.php' ? 'active' : '' ?>">
                <i class="fas fa-flag-checkered"></i> Pautas Finais
            </a>
            
            <a href="<?= SITE_URL ?>professor/frequencia.php" class="<?= basename($_SERVER['PHP_SELF']) == 'frequencia.php' ? 'active' : '' ?>">
                <i class="fas fa-clipboard-check"></i> Frequência
            </a>
            
            <a href="<?= SITE_URL ?>professor/relatorios.php" class="<?= basename($_SERVER['PHP_SELF']) == 'relatorios.php' ? 'active' : '' ?>">
                <i class="fas fa-chart-bar"></i> Relatórios
            </a>
            
            <a href="<?= SITE_URL ?>professor/configuracoes.php" class="<?= basename($_SERVER['PHP_SELF']) == 'configuracoes.php' ? 'active' : '' ?>">
                <i class="fas fa-cog"></i> Configurações
            </a>

            <div class="nav-section-divider"></div>
            
            <a href="<?= SITE_URL ?>professor/perfil.php" class="<?= basename($_SERVER['PHP_SELF']) == 'perfil.php' ? 'active' : '' ?>">
            ...
            <!-- NOTIFICAÇÕES - LINK COM ID CORRETO -->
            <a href="javascript:void(0)" class="notifications-toggle" id="notificationsToggle" onclick="toggleNotifications(event)">
                <i class="fas fa-bell"></i> 
                Notificações
                <?php if ($notificacoes_nao_lidas > 0): ?>
                    <span class="notification-badge" id="notificationBadge"><?= $notificacoes_nao_lidas ?></span>
                <?php endif; ?>
        ...
        <div class="sidebar-footer">
            <div style="text-align: center; color: rgba(255,255,255,0.2); font-size: 10px; padding: 10px 0;">
                SoftGest v1.0
            </div>
        </div>
    </aside>
