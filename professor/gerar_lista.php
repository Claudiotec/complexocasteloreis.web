...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="pautas_trimestrais.php" class="<?= $active_page == 'pautas_trimestrais' ? 'active' : '' ?>">
            <i class="fas fa-edit"></i> Pautas Trimestrais
        </a>
        ...
        <a href="relatorios.php" class="<?= $active_page == 'relatorios' ? 'active' : '' ?>">
            <i class="fas fa-chart-bar"></i> Relatórios
        </a>

        <div class="nav-label" style="margin-top:12px;">Relatórios</div>
        <a href="gerar_lista_nominal.php" class="<?= $active_page == 'gerar_lista' ? 'active' : '' ?>">
...
<!-- ============================================
   SCRIPTS INLINE (Tudo em um só arquivo)
   ============================================ -->
<script>
// ============================================
...
function toggleNotifications(event) {
    ...
    // Fechar lista nominal se estiver aberto
    if (listaDropdown) {
