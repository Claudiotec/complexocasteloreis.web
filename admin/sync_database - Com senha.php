...
function realizarBackupCompleto() {
    ...
    try {
        ...
        // Também salvar uma cópia com data/hora (histórico - opcional)
        // Comentado para manter apenas o arquivo único
        // $caminhoHistorico = BACKUP_FOLDER_DOCUMENTS . 'historico/' . date('Y-m-d_H-i-s') . '_backup.sql';
