...
<div class="container">
    ...
    <div class="alert info" style="font-size: 13px; padding: 10px 16px;">
    ...
    <form method="POST" enctype="multipart/form-data" id="uploadForm">
        <div class="upload-area" id="uploadArea">
            ...
            <input type="file" name="sql_file" id="sqlFile" accept=".sql,.txt">
            <div class="mt-10">
                <button type="button" class="btn btn-primary btn-sm" onclick="document.getElementById('sqlFile').click()">
                    📁 Selecionar
                </button>
            </div>
        </div>
