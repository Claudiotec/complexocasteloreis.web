...
if ($selectedTable) {
    try {
        ...
        // Buscar dados - limitar a 100 registros para performance
        $tableData = $pdo->query("SELECT * FROM `$selectedTable` ORDER BY `$primaryKey` DESC LIMIT 100")->fetchAll(PDO::FETCH_ASSOC);
...
<body>
            ...
            <div class="table-content">
                ...
                <div class="table-toolbar">
                    <div>
                        ...
                        <span class="badge"><?= count($tableData) ?> registros</span>
                        <span class="badge" style="background: rgba(34, 197, 94, 0.2); color: #4ade80; margin-left: 5px;">
                            ⚡ Duplo clique para editar
                        </span>
                    </div>
                    <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                        <a href="?export=table&table_name=<?= urlencode($selectedTable) ?>" class="btn btn-success btn-sm">📤 Exportar</a>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th><?= htmlspecialchars($col['Field']) ?>
                                    <span style="font-weight:300;color:rgba(255,255,255,0.3);font-size:10px;">
                                        <?= $col['Type'] ?>
                                    </span>
                                </th>
                                <?php endforeach; ?>
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr data-id="<?= addslashes($row[$primaryKey] ?? '') ?>">
                                ...
                                <?php foreach ($tableColumns as $col): 
                                    ...
                                    // Verificar se é editável (não é PK e não é auto-increment)
    ...
    <script>
        ...
        function refreshTable() {
            window.location.href = '?table=' + encodeURIComponent(currentTable);
        }
        
        // ===== EDIÇÃO INLINE =====
        function startInlineEdit(element, field) {
            // Não permitir editar a chave primária
            ...
            // Salvar valor original para cancelar
            originalValue = input.value;
            
            // Mostrar input, esconder valor
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Atualizar botões quando selecionar com rádio
