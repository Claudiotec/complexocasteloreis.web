...
<head>
    ...
    <style>
        ...
        * {
        ...
        .sidebar-escola .sidebar-nav a .nav-badge.primary {
            background: rgba(52, 152, 219, 0.2);
            color: #3498db;
        }
        .sidebar-escola .sidebar-nav a .nav-badge.success {
            background: rgba(46, 204, 113, 0.2);
            color: #2ecc71;
        }
        .sidebar-escola .sidebar-nav a .nav-badge.info {
            background: rgba(52, 152, 219, 0.2);
            color: #3498db;
        }
        .sidebar-escola .sidebar-nav a .nav-badge.warning {
            background: rgba(243, 156, 18, 0.2);
            color: #f39c12;
        }
        .sidebar-escola .sidebar-nav a .nav-badge.danger {
            background: rgba(231, 76, 60, 0.2);
            color: #e74c3c;
        }
        .sidebar-escola .sidebar-nav a .nav-badge.purple {
        ...
        /* Estilo do ícone de mensagens no topo */
        .mensagens-top-icon {
            position: relative;
            display: inline-flex;
            align-items: center;
        ...
        .mensagens-top-icon .badge-count.zero {
            display: none;
        }
...
<aside class="sidebar-escola" id="sidebarEscola">
    ...
    <nav class="sidebar-nav">
        ...
        <li>
            <a href="/softgest_web/modules/escola/chamada.php">
                <i class="fas fa-phone"></i> 📞 Chamada
                <?php 
                // Contar chamadas pendentes para este usuário
                try {
                ...
                ?>
                <span class="badge-chamada" style="background: #e74c3c; color: white; border-radius: 50%; padding: 2px 8px; font-size: 11px; font-weight: bold; animation: pulse 1.5s infinite; margin-left: 5px;">
                    <?= $pendentes['total'] ?>
                </span>
                <?php 
                    endif;
                } catch (Exception $e) {
                    // Se a tabela não existir ainda, ignora
                }
                ?>
            </a>
        </li>
    ...
    <li class="nav-item">
        <a href="<?= SITE_URL ?>network_access.php" class="nav-link">
            <i class="fas fa-wifi"></i> 🌐 Acesso à Rede
        </a>
    </li>

    <li class="nav-item">
        <a href="<?= SITE_URL ?>monitorar_dispositivos.php" class="nav-link">
            <i class="fas fa-wifi"></i> 📡 Monitor de Dispositivos
        </a>
    </li>
            

    <li class="nav-item">
        <a href="../../rede_info.php" class="nav-link">
            🌐 Acesso à Rede por ip
        </a>
    </li>
...
<main class="main-content-escola" id="mainContentEscola">
    ...
    <div class="nav-top-escola">
        ...
        <!-- ===== LINK MENSAGENS NA NAVEGAÇÃO SUPERIOR ===== -->
        <?php if (file_exists(__DIR__ . '/mensagens_functions.php')): ?>
