...
// ============================================
// VERIFICAR PAGAMENTO DO CARTÃO (APENAS VALOR 1500.00)
// ============================================
define('VALOR_CARTAO', 1500.00);    // Valor do cartão escolar
...
// ============================================
// PROCESSAR GERAÇÃO EM MASSA (COM VERIFICAÇÃO)
// ============================================
$modo_massa = false;
$alunos_massa = [];
$alunos_bloqueados = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['gerar_massa'])) {
    ...
    try {
        ...
        if (empty($erro_massa)) {
            ...
            // ===== FILTRAR APENAS OS QUE TÊM PAGAMENTO =====
            $alunos_massa = [];
            $alunos_bloqueados = [];
...
// ============================================
// MODO INDIVIDUAL (COM VERIFICAÇÃO)
// ============================================
$id = $_GET['id'] ?? 0;
$aluno = null;
