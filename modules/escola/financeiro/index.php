...
// ============================================
// FUNÇÕES PARA ORÇAMENTO E PLANO DE CONTAS
// ============================================

/**
 * Cria a estrutura padrão do plano de contas
 */
function criarPlanoContas($pdo) {
    $planos = [
        // ATIVO
        ['codigo' => '1', 'nome' => 'ATIVO', 'tipo' => 'ativo', 'nivel' => 1, 'pai_id' => null],
        ['codigo' => '1.1', 'nome' => 'Ativo Circulante', 'tipo' => 'ativo', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '1.1.1', 'nome' => 'Caixa', 'tipo' => 'ativo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '1.1.2', 'nome' => 'Bancos', 'tipo' => 'ativo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '1.1.3', 'nome' => 'Aplicações Financeiras', 'tipo' => 'ativo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '1.1.4', 'nome' => 'Contas a Receber', 'tipo' => 'ativo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '1.1.5', 'nome' => 'Estoques', 'tipo' => 'ativo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '1.2', 'nome' => 'Ativo Não Circulante', 'tipo' => 'ativo', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '1.2.1', 'nome' => 'Imobilizado', 'tipo' => 'ativo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '1.2.2', 'nome' => 'Intangível', 'tipo' => 'ativo', 'nivel' => 3, 'pai_id' => null],
        
        // PASSIVO
        ['codigo' => '2', 'nome' => 'PASSIVO', 'tipo' => 'passivo', 'nivel' => 1, 'pai_id' => null],
        ['codigo' => '2.1', 'nome' => 'Passivo Circulante', 'tipo' => 'passivo', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '2.1.1', 'nome' => 'Fornecedores', 'tipo' => 'passivo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '2.1.2', 'nome' => 'Obrigações Trabalhistas', 'tipo' => 'passivo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '2.1.3', 'nome' => 'Obrigações Tributárias', 'tipo' => 'passivo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '2.1.4', 'nome' => 'Contas a Pagar', 'tipo' => 'passivo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '2.2', 'nome' => 'Passivo Não Circulante', 'tipo' => 'passivo', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '2.2.1', 'nome' => 'Financiamentos', 'tipo' => 'passivo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '2.3', 'nome' => 'Patrimônio Líquido', 'tipo' => 'passivo', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '2.3.1', 'nome' => 'Capital Social', 'tipo' => 'passivo', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '2.3.2', 'nome' => 'Reservas', 'tipo' => 'passivo', 'nivel' => 3, 'pai_id' => null],
        
        // RECEITA
        ['codigo' => '3', 'nome' => 'RECEITA', 'tipo' => 'receita', 'nivel' => 1, 'pai_id' => null],
        ['codigo' => '3.1', 'nome' => 'Receita Operacional', 'tipo' => 'receita', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '3.1.1', 'nome' => 'Mensalidades', 'tipo' => 'receita', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '3.1.2', 'nome' => 'Matrículas', 'tipo' => 'receita', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '3.1.3', 'nome' => 'Emolumentos', 'tipo' => 'receita', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '3.1.4', 'nome' => 'Taxas Diversas', 'tipo' => 'receita', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '3.2', 'nome' => 'Receita Não Operacional', 'tipo' => 'receita', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '3.2.1', 'nome' => 'Aluguéis', 'tipo' => 'receita', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '3.2.2', 'nome' => 'Aplicações Financeiras', 'tipo' => 'receita', 'nivel' => 3, 'pai_id' => null],
        
        // DESPESA
        ['codigo' => '4', 'nome' => 'DESPESA', 'tipo' => 'despesa', 'nivel' => 1, 'pai_id' => null],
        ['codigo' => '4.1', 'nome' => 'Despesa Operacional', 'tipo' => 'despesa', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '4.1.1', 'nome' => 'Salários e Encargos', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.1.2', 'nome' => 'Material Escolar', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.1.3', 'nome' => 'Alimentação', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.1.4', 'nome' => 'Água e Energia', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.1.5', 'nome' => 'Telefonia e Internet', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.1.6', 'nome' => 'Material de Limpeza', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.1.7', 'nome' => 'Manutenção e Reparos', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.1.8', 'nome' => 'Publicidade e Marketing', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.2', 'nome' => 'Despesa Não Operacional', 'tipo' => 'despesa', 'nivel' => 2, 'pai_id' => null],
        ['codigo' => '4.2.1', 'nome' => 'Juros e Multas', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
        ['codigo' => '4.2.2', 'nome' => 'Perdas e Baixas', 'tipo' => 'despesa', 'nivel' => 3, 'pai_id' => null],
    ];
    ...
    foreach ($planos as $plano) {
        try {
            ...
            $check = $pdo->prepare("SELECT id FROM plano_contas WHERE codigo = ?");
            $check->execute([$plano['codigo']]);
            if (!$check->fetch()) {
                $stmt = $pdo->prepare("
                    INSERT INTO plano_contas (codigo, nome, tipo, nivel, pai_id, created_at) 
                    VALUES (?, ?, ?, ?, ?, NOW())
                ");
                $stmt->execute([
                    $plano['codigo'],
...
/**
 * Cria um orçamento base com os valores padrão
 */
function criarOrcamentoBase($pdo, $ano = null) {
    if (!$ano) {
        $ano = date('Y');
    }
    ...
    try {
        ...
        // Valores sugeridos para cada conta
        $valores_sugeridos = [
            '3.1.1' => 50000, // Mensalidades
            '3.1.2' => 2000,  // Matrículas
            '3.1.3' => 1500,  // Emolumentos
            '3.1.4' => 500,   // Taxas Diversas
            '3.2.1' => 1000,  // Aluguéis
            '3.2.2' => 300,   // Aplicações Financeiras
            '4.1.1' => 25000, // Salários e Encargos
            '4.1.2' => 3000,  // Material Escolar
            '4.1.3' => 2000,  // Alimentação
            '4.1.4' => 1500,  // Água e Energia
            '4.1.5' => 500,   // Telefonia e Internet
            '4.1.6' => 500,   // Material de Limpeza
            '4.1.7' => 1000,  // Manutenção e Reparos
            '4.1.8' => 800,   // Publicidade e Marketing
        ];
        
        foreach ($contas as $conta) {
            // Valor sugerido ou 0
            $valor_mensal = $valores_sugeridos[$conta['codigo']] ?? 0;
            ...
            if ($conta['tipo'] === 'receita') {
                // Receitas: distribuição mais uniforme, mas com picos em meses de matrícula
                $base_mensal = $valor_mensal;
                $janeiro = $base_mensal * 1.5;  // Janeiro: matrículas
                $fevereiro = $base_mensal;
                $marco = $base_mensal;
                $abril = $base_mensal;
                $maio = $base_mensal;
                $junho = $base_mensal;
                $julho = $base_mensal;
                $agosto = $base_mensal * 1.5;   // Agosto: matrículas
                $setembro = $base_mensal;
                $outubro = $base_mensal;
                $novembro = $base_mensal;
                $dezembro = $base_mensal;
                
                if ($conta['codigo'] === '3.1.2' || $conta['codigo'] === '3.1.1') {
                    $janeiro = $valor_mensal * 2;
                    $agosto = $valor_mensal * 2;
                }
                
                $total_receita += $valor_anual;
            } else {
                // Despesas: distribuição uniforme
                $janeiro = $fevereiro = $marco = $abril = $maio = $junho = 
                $julho = $agosto = $setembro = $outubro = $novembro = $dezembro = $valor_mensal;
                $total_despesa += $valor_anual;
            }
...
if ($is_admin && isset($_GET['acao'])) {
    if ($_GET['acao'] === 'criar_plano_contas') {
        $resultado = criarPlanoContas($pdo);
        $mensagem_acao = "✅ Plano de Contas criado com sucesso! $resultado contas inseridas.";
        $tipo_acao = 'success';
    }
    
    if ($_GET['acao'] === 'criar_orcamento') {
        $ano = isset($_GET['ano']) ? intval($_GET['ano']) : date('Y');
        $resultado = criarOrcamentoBase($pdo, $ano);
        
        if ($resultado['status'] === 'sucesso') {
            $mensagem_acao = sprintf(
                "✅ Orçamento %d criado com sucesso! %d itens | Receita: %.2f | Despesa: %.2f | Líquido: %.2f",
                $ano,
            ...
            $mensagem_acao = "ℹ️ " . $resultado['mensagem'];
            $tipo_acao = 'info';
        } else {
            $mensagem_acao = "❌ " . $resultado['mensagem'];
            $tipo_acao = 'error';
        }
    }
}
...
try {
    $check = $pdo->query("SELECT COUNT(*) FROM orcamento WHERE ano = " . date('Y'));
    $orcamento_existe = $check->fetchColumn() > 0;
} catch (Exception $e) {
    $orcamento_existe = false;
}
...
<style>
    ...
    .submenu-financeiro .submenu-divider {
        width: 1px;
        height: 30px;
        background: #e2e8f0;
        margin: 0 4px;
    ...
    .submenu-financeiro .submenu-label {
        font-size: 11px;
        color: var(--gray);
    ...
    /* ============================================
       SEÇÃO ADMIN - ORÇAMENTO E PLANO DE CONTAS
       ============================================ */
    .admin-section {
    ...
    .admin-section .section-header .badge-admin {
    ...
    .admin-section .acoes-admin .status-indicator {
        display: inline-flex;
        align-items: center;
        gap: 6px;
        padding: 4px 14px;
    ...
    .admin-section .acoes-admin .status-indicator .dot {
        width: 8px;
        height: 8px;
        border-radius: 50%;
    ...
    .admin-section .acoes-admin .status-indicator .dot.verde { background: #2ecc71; }
    .admin-section .acoes-admin .status-indicator .dot.vermelho { background: #e74c3c; }
    .admin-section .acoes-admin .status-indicator .dot.amarelo { background: #f39c12; }
...
<div class="financeiro-container">
    ...
    <nav class="submenu-financeiro animate-left" style="animation-delay: 0.1s;">
        ...
        <?php if ($is_admin): ?>
            <span class="submenu-divider"></span>
            <span class="submenu-label">🔑 Admin</span>
            <a href="plano_contas/" class="btn-sm">📋 Plano de Contas</a>
            <a href="orcamento/" class="btn-sm">📊 Orçamento</a>
        <?php endif; ?>
    </nav>

    <?php if ($mensagem_acao): ?>
    <div class="alert alert-<?= $tipo_acao ?>" style="margin-bottom: 20px; padding: 12px 18px; border-radius: 8px; <?= $tipo_acao === 'success' ? 'background: #d1fae5; color: #065f46; border: 1px solid #a7f3d0;' : ($tipo_acao === 'error' ? 'background: #fee2e2; color: #991b1b; border: 1px solid #fca5a5;' : 'background: #dbeafe; color: #1e40af; border: 1px solid #93c5fd;') ?>">
        <?= htmlspecialchars($mensagem_acao) ?>
    </div>
    <?php endif; ?>

    <!-- ===== SEÇÃO ADMIN - ORÇAMENTO E PLANO DE CONTAS ===== -->
    <?php if ($is_admin): ?>
    <div class="admin-section animate-left" style="animation-delay: 0.12s;">
        <div class="section-header">
            ...
            <div style="display: flex; gap: 8px; flex-wrap: wrap; align-items: center;">
                <span class="status-indicator">
                    <span class="dot <?= $plano_existe ? 'verde' : 'vermelho' ?>"></span>
                    Plano de Contas: <?= $plano_existe ? '✅ Configurado' : '❌ Não criado' ?>
                </span>
                <span class="status-indicator">
                    <span class="dot <?= $orcamento_existe ? 'verde' : 'amarelo' ?>"></span>
                    Orçamento <?= date('Y') ?>: <?= $orcamento_existe ? '✅ Criado' : '⏳ Pendente' ?>
                </span>
            </div>
        </div>
        
        <div class="section-desc">
            Configure a estrutura contábil da empresa e crie o orçamento anual para controle financeiro.
        </div>
        
        <div class="acoes-admin">
            <?php if (!$plano_existe): ?>
                <a href="?acao=criar_plano_contas" class="btn btn-purple" onclick="return confirm('Deseja criar o Plano de Contas padrão? Isso irá configurar toda a estrutura contábil da empresa.');">
                    📋 Criar Plano de Contas
                </a>
            <?php else: ?>
                <a href="plano_contas/" class="btn btn-info">
                    📋 Ver Plano de Contas
                </a>
            <?php endif; ?>
            
            <?php if ($plano_existe && !$orcamento_existe): ?>
                <a href="?acao=criar_orcamento" class="btn btn-gold" onclick="return confirm('Deseja criar o orçamento para <?= date('Y') ?>? Serão gerados valores base para todas as contas.');">
                    📊 Criar Orçamento <?= date('Y') ?>
                </a>
            <?php endif; ?>
            
            <?php if ($plano_existe && $orcamento_existe): ?>
                <a href="orcamento/" class="btn btn-warning">
                    📊 Ver Orçamento <?= date('Y') ?>
                </a>
            <?php endif; ?>
            
            <?php if ($plano_existe): ?>
                <a href="?acao=criar_orcamento&ano=<?= date('Y') + 1 ?>" class="btn btn-secondary btn-sm" onclick="return confirm('Deseja criar o orçamento para <?= date('Y') + 1 ?>?');">
                    ➕ Criar Orçamento <?= date('Y') + 1 ?>
                </a>
            <?php endif; ?>
            
            <?php if (!$plano_existe): ?>
                <a href="plano_contas/importar.php" class="btn btn-secondary btn-sm">
