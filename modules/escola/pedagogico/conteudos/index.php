<?php
// ============================================
// modules/escola/pedagogico/conteudos/index.php - Conteúdos
// ============================================
...
<div class="main-content">
    <div class="page-header">
        <h1>📚 Conteúdos</h1>
        <p>Organize conteúdos programáticos por disciplina e turma</p>
        <div class="breadcrumb">
            <a href="../../../index.php">Dashboard</a> / 
            <a href="../index.php">Pedagógico</a> / Conteúdos
        </div>
    </div>
    ...
    <div class="card">
        <h3 class="card-title">📋 Conteúdos Programáticos</h3>
        
        <div style="text-align: center; padding: 60px 20px;">
            <div style="font-size: 64px; margin-bottom: 16px;">📚</div>
            <p style="font-size: 20px; color: #1a2332; font-weight: 600;">Nenhum conteúdo cadastrado</p>
            <p style="color: #94a3b8; font-size: 16px; margin-top: 8px;">Organize os conteúdos por disciplina</p>
