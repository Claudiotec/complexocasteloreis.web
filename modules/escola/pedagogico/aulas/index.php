<?php
// ============================================
// modules/escola/pedagogico/aulas/index.php - Aulas
// ============================================
...
<div class="main-content">
    <div class="page-header">
        <h1>🎯 Aulas</h1>
        <p>Gerencie aulas e conteúdos ministrados</p>
        <div class="breadcrumb">
            <a href="../../../index.php">Dashboard</a> / 
            <a href="../index.php">Pedagógico</a> / Aulas
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div style="text-align: center; padding: 60px 20px;">
            ...
            <p style="font-size: 20px; color: #1a2332; font-weight: 600;">Nenhuma aula registrada</p>
            <p style="color: #94a3b8; font-size: 16px; margin-top: 8px;">Registre suas aulas e conteúdos ministrados</p>
