<?php
// ============================================
// modules/escola/pedagogico/habilidades/index.php - Habilidades
// ============================================
...
<div class="main-content">
    <div class="page-header">
        ...
        <p>Alinhamento com BNCC e competências gerais</p>
        <div class="breadcrumb">
            <a href="../../../index.php">Dashboard</a> / 
            <a href="../index.php">Pedagógico</a> / Habilidades
        </div>
    </div>
    ...
    <div style="display: flex; gap: 12px; margin-bottom: 24px; flex-wrap: wrap;">
        ...
        <a href="#" class="btn btn-outline">
            <i class="fas fa-file-import"></i> Importar BNCC
        </a>
    </div>
    ...
    <div class="card" style="padding: 20px;">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 12px;">
            <a href="#" style="text-decoration: none;">
                <div style="background: #f8fafc; padding: 16px; border-radius: 10px; text-align: center; border: 2px solid transparent; transition: all 0.3s;">
                    <div style="font-size: 32px;">📐</div>
                    <div style="font-weight: 600; color: #1a2332; margin-top: 4px;">Matemática</div>
                    <div style="font-size: 12px; color: #94a3b8;">0 habilidades</div>
                </div>
            </a>
            <a href="#" style="text-decoration: none;">
                <div style="background: #f8fafc; padding: 16px; border-radius: 10px; text-align: center; border: 2px solid transparent; transition: all 0.3s;">
                    <div style="font-size: 32px;">📖</div>
                    <div style="font-weight: 600; color: #1a2332; margin-top: 4px;">Português</div>
                    <div style="font-size: 12px; color: #94a3b8;">0 habilidades</div>
                </div>
            </a>
            <a href="#" style="text-decoration: none;">
                <div style="background: #f8fafc; padding: 16px; border-radius: 10px; text-align: center; border: 2px solid transparent; transition: all 0.3s;">
                    <div style="font-size: 32px;">🔬</div>
                    <div style="font-weight: 600; color: #1a2332; margin-top: 4px;">Ciências</div>
                    <div style="font-size: 12px; color: #94a3b8;">0 habilidades</div>
                </div>
            </a>
            <a href="#" style="text-decoration: none;">
                <div style="background: #f8fafc; padding: 16px; border-radius: 10px; text-align: center; border: 2px solid transparent; transition: all 0.3s;">
                    <div style="font-size: 32px;">🌍</div>
                    <div style="font-weight: 600; color: #1a2332; margin-top: 4px;">História/Geo</div>
                    <div style="font-size: 12px; color: #94a3b8;">0 habilidades</div>
                </div>
            </a>
        </div>
    ...
    <div class="card">
        <h3 class="card-title">📋 Habilidades Cadastradas</h3>
        
        <div style="text-align: center; padding: 60px 20px;">
            <div style="font-size: 64px; margin-bottom: 16px;">🧠</div>
            <p style="font-size: 20px; color: #1a2332; font-weight: 600;">Nenhuma habilidade cadastrada</p>
            <p style="color: #94a3b8; font-size: 16px; margin-top: 8px;">Cadastre habilidades alinhadas à BNCC</p>
